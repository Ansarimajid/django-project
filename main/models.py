...
class Req(models.Model):
    ...
    rsymptoms = MultiSelectField(choices=RSYMPTOMS, null=True)
    rprior_ailments = models.TextField()
    rbed_num = models.ForeignKey("Bed", on_delete=models.CASCADE)
    rdob = models.DateField(null=True)
    rdoctor = models.ForeignKey("Doctor", on_delete=models.CASCADE, null=True)
    rdoctors_notes = models.TextField(null=True, blank=True)
    rdoctors_visiting_time = models.CharField(null=True, max_length=50, blank=True)
